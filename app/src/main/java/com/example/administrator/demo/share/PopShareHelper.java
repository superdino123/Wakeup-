...
import com.example.administrator.demo.share.qq.QQShareUtil;
    ...
    private void initView() {
        ...
        iv_share_wx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (wxApi.isWXAppInstalled()) {
                    pop.dismiss();
                    com.example.administrator.demo.share.wx.WXShareUtil.shareToWX(context, wxApi, shareContent);
                } else {
        ...
        iv_share_wx_circle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (wxApi.isWXAppInstalled()) {
                    pop.dismiss();
                    com.example.administrator.demo.share.wx.WXShareUtil.shareToWXCircle(context, wxApi, shareContent);
                } else {
                    ToastUtil.showToast(context, "请先安装微信");
                }
